...
def dashboard():
    return render_template("v1/dashboard.html", initial_tab=request.args.get("tab", "landing"))


@v1_ui_bp.route("/dashboard/operations")
def dashboard_operations():
    return redirect(url_for("v1_ui.dashboard", tab="operations"))


@v1_ui_bp.route("/operations")
def operations():
    return redirect(url_for("v1_ui.dashboard", tab="operations"))
